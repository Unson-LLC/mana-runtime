...
const TOOL_DEFINITIONS = Object.freeze([
  ...
  { name: "list_tasks_across_channels", description: "明示的に許可された複数チャンネルのタスクを、チャンネル名またはIDで最大20件一覧します。対象projectはサーバー側で解決します。", inputSchema: { type: "object", additionalProperties: false, oneOf: [{ required: ["channel_ids"], not: { required: ["channel_names"] } }, { required: ["channel_names"], not: { required: ["channel_ids"] } }], properties: { channel_ids: { type: "array", minItems: 1, maxItems: 10, uniqueItems: true, items: { type: "string", pattern: "^[A-Z0-9_]{2,32}$" } }, channel_names: { type: "array", minItems: 1, maxItems: 10, uniqueItems: true, items: { type: "string", minLength: 1, maxLength: 82 } }, status: { type: "string" }, priority: { type: "string" }, assignee_person_id: { type: "string" }, cursor: { type: "string" }, limit: { type: "integer", minimum: 1, maximum: 20 } } } },
  { name: "search_tasks_across_channels", description: "明示的に許可された複数チャンネルのタスクを、チャンネル名またはIDで最大20件検索します。対象projectはサーバー側で解決します。", inputSchema: { type: "object", additionalProperties: false, required: ["query"], oneOf: [{ required: ["channel_ids"], not: { required: ["channel_names"] } }, { required: ["channel_names"], not: { required: ["channel_ids"] } }], properties: { channel_ids: { type: "array", minItems: 1, maxItems: 10, uniqueItems: true, items: { type: "string", pattern: "^[A-Z0-9_]{2,32}$" } }, channel_names: { type: "array", minItems: 1, maxItems: 10, uniqueItems: true, items: { type: "string", minLength: 1, maxLength: 82 } }, query: { type: "string", minLength: 1, maxLength: 200 }, status: { type: "string" }, priority: { type: "string" }, assignee_person_id: { type: "string" }, cursor: { type: "string" }, limit: { type: "integer", minimum: 1, maximum: 20 } } } },
