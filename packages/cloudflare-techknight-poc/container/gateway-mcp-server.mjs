...
const TOOL_DEFINITIONS = Object.freeze([
  ...
  { name: "list_tasks", description: "許可projectのタスクを一覧します。", inputSchema: { type: "object", additionalProperties: false, properties: { status: { type: "string" }, priority: { type: "string" }, assignee_person_id: { type: "string" }, cursor: { type: "string" }, limit: { type: "integer", minimum: 1, maximum: 20 } } } },
